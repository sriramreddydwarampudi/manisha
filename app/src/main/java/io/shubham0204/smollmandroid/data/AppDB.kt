...
class AppDB(context: Context) {
    ...
    fun addChat(
        chatName: String,
        chatTemplate: String = "",
        systemPrompt: String = "You are a friendly, caring AI companion named Amigo. Your goal is to support and chat with the user in a helpful, warm, and personal way. Remember details the user shares about themselves to provide a personalized experience. Keep your responses conversational and concise, like a friend on WhatsApp.",
        llmModelId: Long = -1,
